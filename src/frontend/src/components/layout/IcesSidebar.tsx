  ...
  switch (role) {
    case "collaborateur":
      return [
        ...
        { id: "sep3",              label: "Projets & Tâches",        type: "separator" },
        { id: "projets_collab",    label: "Mes projets",             icon: Briefcase,     route: "/projects" },
        { id: "sep4",              label: "Communication",           type: "separator" },
