import { c as createLucideIcon, s as useParams, f as useNavigate, a as useApi, r as reactExports, j as jsxRuntimeExports, S as Shield, p as User, F as FileText, k as apiFetch } from "./index-BeBYdaDm.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-px bg-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-6 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Sexe", value: employee.gender || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Nationalité", value: employee.nationality || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Né(e) le", value: employee.birth_date || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "À", value: employee.birth_place || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Pièce ID", value: employee.id_type || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Expire le", value: employee.id_expiry || "—" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-6 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-bold text-sm flex items-center gap-2 mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Statut", value: employee.marital_status || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Enfants", value: ((_a = employee.children_count) == null ? void 0 : _a.toString()) || "0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Contact Urgence", value: employee.emergency_contact || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Relation", value: employee.emergency_relation || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Tél Urgence", value: employee.emergency_phone || "—" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-6 space-y-4 border-t border-border", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Email Perso", value: employee.personal_email || "—" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card p-6 space-y-4 border-t border-border", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Manager", value: employee.manager || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Entrée le", value: employee.hired || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Salaire Base", value: employee.salary_base ? `${employee.salary_base} FCFA` : "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "RIB", value: employee.bank_account || "—" })
            ] })
          ] })
        ] }) }) }),
