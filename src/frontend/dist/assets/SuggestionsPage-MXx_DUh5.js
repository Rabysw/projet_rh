import { c as createLucideIcon, r as reactExports, a as useApi, j as jsxRuntimeExports, M as MessageSquare, d as Clock, k as apiFetch } from "./index-Wq93vx8q.js";
...
function SuggestionsPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      ue.success("Suggestion envoyée avec succès !");
      setMessage("");
      refetch();
    } catch (err) {
      ue.error(err instanceof Error ? err.message : "Erreur lors de l'envoi");
    } finally {
