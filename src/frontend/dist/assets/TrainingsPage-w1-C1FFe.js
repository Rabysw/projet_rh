const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/download-C8xds31Q.js","assets/index-BeBYdaDm.js","assets/index-DQxxRqX6.css"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, a as useApi, r as reactExports, j as jsxRuntimeExports, d as Clock, X as Star, M as MessageSquare, k as apiFetch, _ as __vitePreload } from "./index-BeBYdaDm.js";
  ...
  const handleDownloadCertificate = async (id, title) => {
    try {
      const { downloadFile } = await __vitePreload(async () => {
        const { downloadFile: downloadFile2 } = await import("./download-C8xds31Q.js");
