import { c as createLucideIcon, l as useCompanyConfig, r as reactExports, j as jsxRuntimeExports } from "./index-Wq93vx8q.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-BYN6OFYS.js";
...
function AdminConfigPage() {
  ...
  const [newJob, setNewJob] = reactExports.useState("");
  const [newHoliday, setNewHoliday] = reactExports.useState({ date: "", label: "" });
  const [importReport, setImportReport] = reactExports.useState(null);
  reactExports.useEffect(() => {
    if (config) setFormData({ ...config });
  }, [config]);
  const canSave = !!(formData == null ? void 0 : formData.company_name) && ((_a = formData == null ? void 0 : formData.departments) == null ? void 0 : _a.length) > 0 && ((_b = formData == null ? void 0 : formData.job_titles) == null ? void 0 : _b.length) > 0;
  const handleSave = async () => {
    if (!canSave) {
      ue.error("Veuillez renseigner les champs obligatoires (nom, départements, postes)");
      return;
    }
    ...
    try {
      ...
      await refreshConfig();
      ue.success("Configuration mise à jour avec succès");
    } catch (err) {
      ue.error(err instanceof Error ? err.message : "Erreur de mise à jour");
    } finally {
      setIsSubmitting(false);
    }
  };
  const handleDownloadTemplate = () => {
    const ws = utils.aoa_to_sheet([REQUIRED_COLUMNS]);
    const wb = utils.book_new();
    utils.book_append_sheet(wb, ws, "Employes");
    writeFileSync(wb, "template_import_employes.xlsx");
    ue.success("Template téléchargé");
  };
  const validateImportRows = (rows) => {
    ...
    rows.forEach((row, idx) => {
      ...
      for (const col of REQUIRED_COLUMNS) {
        if (row[col] === void 0 || row[col] === null || String(row[col]).trim() === "") {
          errors.push(`Ligne ${line}: colonne '${col}' manquante`);
        }
      }
      if (row["Département"] && Array.isArray(formData == null ? void 0 : formData.departments) && !formData.departments.includes(String(row["Département"]))) {
        errors.push(`Ligne ${line}: département inconnu (${row["Département"]})`);
      }
      if (row["Poste"] && Array.isArray(formData == null ? void 0 : formData.job_titles) && !formData.job_titles.includes(String(row["Poste"]))) {
  ...
  const handleUploadTemplate = async (file) => {
    try {
      ...
      if (report.errors.length === 0) {
        ue.success(`${report.imported} employé(s) prêt(s) à être importé(s)`);
      } else {
        ue.error("Des erreurs ont été détectées dans le fichier");
      }
    } catch {
      ue.error("Fichier Excel invalide");
    }
  };
  if (!formData) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-64 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-foreground", children: "Configuration entreprise" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Modifiez les paramètres globaux et les règles RH." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleSave, disabled: isSubmitting, className: "gap-2", children: [
        isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "animate-spin size-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { size: 18 }),
        "Sauvegarder les modifications"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "identite", className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid grid-cols-5 w-full max-w-4xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "identite", children: "Identité" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "travail", children: "Travail" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "regles", children: "Congés & alertes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "structure", children: "Structure" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "import", children: "Import" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "identite", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Identité de l'entreprise" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Nom entreprise *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.company_name, onChange: (e) => setFormData({ ...formData, company_name: e.target.value }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Logo URL", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.company_logo_url || "", onChange: (e) => setFormData({ ...formData, company_logo_url: e.target.value }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Couleur principale *", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "color", className: "w-12 h-10 p-1", value: formData.primary_color, onChange: (e) => setFormData({ ...formData, primary_color: e.target.value }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.primary_color, onChange: (e) => setFormData({ ...formData, primary_color: e.target.value }) })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Pays *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.country, onChange: (e) => setFormData({ ...formData, country: e.target.value }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Devise *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.currency, onChange: (e) => setFormData({ ...formData, currency: e.target.value }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Préfixe téléphone *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.phone_prefix, onChange: (e) => setFormData({ ...formData, phone_prefix: e.target.value }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Fuseau horaire *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.timezone, onChange: (e) => setFormData({ ...formData, timezone: e.target.value }) }) })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "travail", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Règles de travail" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Heure début *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "time", value: formData.working_hours_start, onChange: (e) => setFormData({ ...formData, working_hours_start: e.target.value }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Heure fin *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "time", value: formData.working_hours_end, onChange: (e) => setFormData({ ...formData, working_hours_end: e.target.value }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Seuil heures sup (h/jour) *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.overtime_threshold_hours, onChange: (e) => setFormData({ ...formData, overtime_threshold_hours: Number(e.target.value) }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Tolérance retard (min) *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.late_alert_threshold_minutes, onChange: (e) => setFormData({ ...formData, late_alert_threshold_minutes: Number(e.target.value) }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Retards/mois avant alerte *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.late_count_alert_per_month, onChange: (e) => setFormData({ ...formData, late_count_alert_per_month: Number(e.target.value) }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Période d'essai (jours) *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.probation_duration_days, onChange: (e) => setFormData({ ...formData, probation_duration_days: Number(e.target.value) }) }) })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "regles", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Congés & alertes" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Congés payés/an *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.leave_days_per_year, onChange: (e) => setFormData({ ...formData, leave_days_per_year: Number(e.target.value) }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Report N-1 max *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.leave_carry_over_max, onChange: (e) => setFormData({ ...formData, leave_carry_over_max: Number(e.target.value) }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Alerte fin contrat (jours) *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.contract_alert_days, onChange: (e) => setFormData({ ...formData, contract_alert_days: Number(e.target.value) }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Alerte expiration pièce (jours) *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.id_expiry_alert_days, onChange: (e) => setFormData({ ...formData, id_expiry_alert_days: Number(e.target.value) }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Alerte visite médicale (jours) *", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: formData.medical_alert_days, onChange: (e) => setFormData({ ...formData, medical_alert_days: Number(e.target.value) }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Types de congés actifs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: (formData.leave_types || []).map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "cursor-pointer", onClick: () => setFormData({ ...formData, leave_types: formData.leave_types.filter((x) => x !== t) }), children: [
              t,
              " ×"
            ] }, i)) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Nouveau type congé", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "structure", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Départements" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: newDept, onChange: (e) => setNewDept(e.target.value), placeholder: "Nouveau département" }),
                ...
                (formData.departments || []).map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(RowTag, { label: d, onDelete: () => setFormData({ ...formData, departments: formData.departments.filter((_, idx) => idx !== i) }) }, `${d}-${i}`))
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Postes" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: newJob, onChange: (e) => setNewJob(e.target.value), placeholder: "Nouveau poste" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      size: "icon",
                ...
                (formData.job_titles || []).map((j, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(RowTag, { label: j, onDelete: () => setFormData({ ...formData, job_titles: formData.job_titles.filter((_, idx) => idx !== i) }) }, `${j}-${i}`))
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "mt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg", children: "Jours fériés" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: newHoliday.date, onChange: (e) => setNewHoliday({ ...newHoliday, date: e.target.value }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: newHoliday.label, onChange: (e) => setNewHoliday({ ...newHoliday, label: e.target.value }), placeholder: "Libellé" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    onClick: () => {
              ...
              (formData.public_holidays || []).map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(RowTag, { label: `${h.date} - ${h.label}`, onDelete: () => setFormData({ ...formData, public_holidays: formData.public_holidays.filter((_, idx) => idx !== i) }) }, `${h.date}-${i}`))
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "import", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-dashed border-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center justify-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FileSpreadsheet, { size: 18 }),
              " Import des employés"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Template Excel + vérification locale des erreurs." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "gap-2", onClick: handleDownloadTemplate, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { size: 16 }),
                "Télécharger le template Excel"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-md border border-input cursor-pointer hover:bg-muted", children: [
            ...
            importReport && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border p-4", children: [
              ...
              importReport.errors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-2 text-sm text-destructive space-y-1", children: importReport.errors.slice(0, 20).map((err, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                "- ",
                err
              ] }, idx)) })
            ] })
...
function Field({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-semibold", children: label }),
    children
  ] });
}
function RowTag({ label, onDelete }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-2 bg-muted/30 rounded border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "h-8 w-8", onClick: onDelete, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14 }) })
  ] });
}
export {
  AdminConfigPage as default
};
